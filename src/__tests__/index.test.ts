...
import { XBLAuthorization, PlayerSettingsResponse } from '../../';
...
it("should retrieve specified player's XUID", async () => {
    const authorization: XBLAuthorization = {
...
it("should retrieve specified player's settings", async () => {
    ...
    const settings: PlayerSettingsResponse = [
        { id: 'Gamertag', value: 'Zeny IC' },
        { id: 'Location', value: 'Paris, France' }
    ];
